...
export type OAuthProvider = 'google' | 'GOOGLE' | 'kakao' | 'KAKAO'

type ProviderIconProps = Omit<ComponentProps<'svg'>, 'children'> & {
...
export function ProviderIcon({
  ...
  if (normalizedProvider === 'google') {
    return (
      <svg viewBox="0 0 24 24" {...props} aria-hidden={ariaHidden} focusable={focusable}>
        <path
